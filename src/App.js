...
//     qualification: "MCA",
//     about: "I am Vidhi Chaurasia, a passionate MCA graduate skilled in programming and problem-solving. With hands-on experience in projects like a Pet Adoption System and a Vehicle Rental System, I focus on building impactful solutions. I love solving DSA problems on LeetCode and continuously improving my technical expertise.",
//     skills: ["C", "C++", "Python", "SQL", "JavaScript", "HTML", "CSS", "React"],
//     projects: [
//       "Get a Friend (Pet Adoption System)",
//       "Auto Care (Vehicle Rental System)"
//     ],
//     achievements: [
//       "Solving DSA on LeetCode in C++ (400+ solved questions)",
//       "Certification on Problem Solving in C (HackerRank)",
//       "Certification on SQL Basic (HackerRank)",
//       "Certification on SQL Advanced (HackerRank)"
//     ]
//   };
...
//       // 👆 added pt-32 so content starts below navbar
...
//         questions solved on LeetCode, certifications in C and SQL from HackerRank,
//         and hands-on experience in building real-world projects like a Pet Adoption
//         System and Vehicle Rental System, I aim to create impactful software solutions.
//       </p>
...
//                   <li key={i} className="flex items-center space-x-2 before:content-['•'] before:mr-2">
//                     {t}
//                   </li>
//                 ))}
//               </ul>
...
// const Achievements = () => {
//   const { achievements } = useContext(PortfolioContext);
//   return (
//     <motion.section
//       id="achievements"
//       className="p-8 bg-white dark:bg-gray-800 dark:text-white rounded-3xl shadow-xl mt-16 mb-16 transition-colors"
//       initial={{ opacity: 0, x: 100 }}
//       whileInView={{ opacity: 1, x: 0 }}
//       transition={{ duration: 0.8 }}
//     >
...
//             className="p-4 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-xl shadow-md cursor-pointer"
//           >
//             {achievement}
//           </motion.li>
//         ))}
...
//         </a>
//       </div>
//       <p className="text-sm">© {new Date().getFullYear()} Vidhi Chaurasia. All rights reserved.</p>
//       <p className="text-xs mt-1">Built with ❤️ using React & TailwindCSS</p>
//     </motion.footer>
//   );
// };
...
//   return (
//     <PortfolioProvider>
//       <div className={darkMode ? "dark min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800" : "min-h-screen bg-gradient-to-br from-gray-100 via-white to-gray-200"}>
